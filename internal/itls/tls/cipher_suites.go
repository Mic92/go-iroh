...
import (
	...
	fipsaes "github.com/tmc/go-iroh/internal/itls/shim/fipsaes"
	gcm "github.com/tmc/go-iroh/internal/itls/shim/fipsgcm"
	"crypto/rc4"
	"crypto/sha1"
	"crypto/sha256"
	"fmt"
	"hash"
	"github.com/tmc/go-iroh/internal/itls/shim/cpu"
	"runtime"
...
func aeadAESGCM(key, noncePrefix []byte) aead {
	...
	if boring.Enabled {
		...
		boring.Unreachable()
		aead, err = gcm.NewGCMForTLS12(fipsaes.New(aes))
	}
	if err != nil {
		panic(err)
	}
...
func aeadAESGCMTLS13(key, nonceMask []byte) aead {
	...
	if boring.Enabled {
		...
		boring.Unreachable()
		aead, err = gcm.NewGCMForTLS13(fipsaes.New(aes))
	}
	if err != nil {
		panic(err)
	}
